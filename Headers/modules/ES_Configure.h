...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "MasterSM.h"
// the name of the Init function
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "Lidar.h"
// the name of the Init function
#define SERV_2_INIT InitLidarService
// the name of the run function
#define SERV_2_RUN RunLidarService
// How big should this services Queue be?
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                /*FindLocationSM*/
                BEACON_ALIGNED,
                FAIL_TO_GET_LOCATION,
								IR_ALIGNED,
								OBTAIN_LOCATION,
								ES_ENTRY_POLLING,
								/*GoToPollingStationSM*/
								GET_DIRECTION,
								/*SPI Event Type*/
								ES_EOT,
                RETURN_RESPONSE_SENDBYTE,
								OCCUPYCOMMAND_PACSM,
								STATUSCOMMAND_PACSM,
								QUERYCOMMAND_PACSM,
								ES_SENDCOMMAND,
						    OCCUPY_SENT_PACSM,
								WHOLE_GAME_STATUS_COLLECTED,
								WHOLE_GAME_STATUS_NOT_COLLECTED,
								RESPONSE_NOT_READY,
								RESPONSE_READY,
								OCCUPY_SUCCEED,
								OCCUPY_UNSUCCEED,
								...
								QUERY_COLLECTED,
								QUERY_NOT_COLLECTED,
						    GAME_STATUS_COLLECTED,
								QUERY_IS_COLLECTED_FOR_OCCUPY,
								/*SPI Public Event Type*/
								CHANGING_STATIONSTATUS_TOPPAC,// this's event's parameter should be frequency(later on will also include color)
								GETTING_GAME_STATUS_TOPPAC, // post this event if you want to know the status of the game
								QUERYING_TOPPAC, // post this event if you want to query
								OCCUPY_IS_SUCCEED,
								WRONG_FIRST_FREQUENCY,
								WRONG_SECOND_FREQUENCY,
								OCCUPY_BLOCKED,
								...
								DISTANCE_FOUND,
								DISTANCE_NOT_FOUND,
								THREEDISTANCE_FOUNDONE,
								THREEDISTANCE_FOUNDTWO,
								GET_DISTANCE,
								/*HallSensor*/
								HALL_DETECT,
								IR_DETECT,
...
#define TIMER11_RESP_FUNC PostLidarService
...
#define FREEZE_TIMER 0
#define SHOOT_FREEZE_TIMER 1
#define SHOOT_TIMER 2
#define FORWARD_TIMER 3
#define CAPTURE_TIMER 4
#define SENDCOMMAND_TIMER 5
#define BYTE_TIMER 6
#define BYTETIMEOUT_TIMER 7
#define MOTOR_TIMER 8
#define ENCODER_TIMER 9
#define INPUT_STOP_TIMER 10
#define LIDAR_TIMER 11
#define QUERY_TIMER 12
#define GAME_TIMER 13
#define SERVO_TIMER 14
#define GOAWAY_TIMER 15
#endif /* CONFIGURE_H */
